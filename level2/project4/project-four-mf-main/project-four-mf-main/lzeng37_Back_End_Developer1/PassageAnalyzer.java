...
public class PassageAnalyzer extends Application
{
	...
	public void start(Stage window) throws Exception 
	{
		...
		mainPanel.getChildren().addAll(inputGroup, passageBoxGroup, outputBoxGroup);
	...
	class loadHandler implements EventHandler<ActionEvent>
	{
		...
		public void handle(ActionEvent arg0) 
		{
			...
			String text = passage.passageGetter();
	...
	class analyzeHandler implements EventHandler<ActionEvent>
	{
		...
		public void handle(ActionEvent e)
		{
			...
			String mostUsed = tool.getMostUsedStarter(passage);
	...
	class findHandler implements EventHandler<ActionEvent>
	{
		...
		public void handle(ActionEvent e)
		{
			...
			Passage passage = tool.analyzePassage(text);
			Boolean result = tool.contains(passage, word);
			
			String filler = "not ";
			if (result)
				filler = "";
			
			outputBox.setText("The word/phrase: '" + word + "' is " + filler + "present in the passage");
		}
	}
}
